...
def invertirImgColores(imagen): # al parecer es la misma que el negativo
...
def main():
    ...
    if rank != 0:
        ...
        arrImgSalida = invertirImgColores(arrTrabajo)    #enviar el arreglo RGB a transformarlo en arreglo negativo de la imagen
    ...
    if rank == 0:       #recibe los arreglos y los junta uno abajo del otro
        ...
        imgContrucFinal.save("invertircolores.png")
